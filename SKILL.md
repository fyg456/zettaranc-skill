...
**一句话**：筹码峰不是预言走势，而是告诉你什么位置该做什么事。集中度判断主力控盘程度，获利比例判断抛压大小，成本区间判断支撑压力。

**详见** → `knowledge/chip-analysis.md`（集中度/获利比例/成本区间/重合度、5步实战分析法、B1筹码修正评分、实战案例库）

**核心三问**：
1. 集中度多少？<5% 说明主力高度控盘，但需结合获利比例看
2. 获利比例多少？>90% 就是高危信号，只卖不买
3. 距70%/90%上沿还有多少空间？空间 < 1% 就不值得做

**局限**：筹码数据需专业软件（指南针等）提供；集中度低+获利高=伪控盘需警惕。
